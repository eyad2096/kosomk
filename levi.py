...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@O_5_H"))
...
async def _(event):
        ...
        await sython.send_message('@zmmbot', 'جاري التجميع بواسطة | LEVI 𝐂𝐇𝐄𝐂𝐊𝐄𝐑')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
        ...
        await sython.send_message('@A_MAN9300BOT', 'جاري التجميع بواسطة |  LEVI')
        channel_entity = await sython.get_entity(bot_usernamee)
...
async def _(event):
      await event.reply("""السـورس يعمـل | 𝐒𝐇𝐀𝐑𝐊 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍

- المطور : عمر القرش | 3MORA

- سورس بسيط يحتوي على الاوامر المهمة التي تحتاجها

قناة السورس : https://t.me/O_5_H
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@sython.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""LEVI OWNER : @O_5_H"""
)
